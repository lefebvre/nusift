...
The SVG scaffolding lives in svgplot.py, shared with the validation report so the two sets of
generated figures cannot drift into different visual languages.
"""
...
from svgplot import Axes, line, polyline, rect, svg, text
